...
<DIV id=regLogin class=wrap>
    <DIV class=dialog>
        ...
        <DIV class=box>
                <FORM id=add_action method=post enctype="multipart/form-data"  name=sss action=updateHouse>
                <DIV class=infos>
                    <TABLE class=field>
                        <TBODY>
                        <TR>
                            <TD class=field>标　　题：<INPUT  value="${house.id}" class=text type=hidden name=id> </TD>
                            <TD><INPUT id=add_action_title value="${house.title}" class=text type=text name=title> </TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><INPUT id=add_action_price value="${house.price}" class=text type=text name=price> </TD>
                        </TR>
                        <TR>
                            <TD class=field>发布日期：</TD>
                            <TD>
                                <INPUT class=text value="<f:formatDate value="${house.pubdate}" pattern="yyyy-MM-dd"></f:formatDate>" type=date name=pubdate></TD></TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><input type="hidden" name="oldPic" value="${house.path}"><img src="http://localhost:80/${house.path}" height="100" width="80"><input type="file" name="pfile"></TD></TR></TBODY></TABLE>
